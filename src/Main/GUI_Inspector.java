	...
	private void inicializarGUI() {
		...
		btnConfirmarUbicacionParquimetro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int opcion = JOptionPane.showConfirmDialog(null, "�Confirma la calle y ubicaci�n?", "Confirmaci�n", JOptionPane.YES_NO_OPTION);
				...
				if (opcion == JOptionPane.OK_OPTION) {
		        	...
		        	if (datos == null) {
		        		JOptionPane.showMessageDialog(null, "Ubicaci�n no asignada", "Error", JOptionPane.CANCEL_OPTION);
		        	}
		        	else {
		        		patentes = new HashSet<String>();
		        		...
		        		frame.setBounds(100, 100, 983, 489); //Agrando el frame a tama�o de la tabla
		        	}
		        }
			}
		});
